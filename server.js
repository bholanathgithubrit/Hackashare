...
const provider = new HttpProvider('https://eth-mainnet.g.alchemy.com/v2/-pWYYtxO4EGvuPdSxjRoK6_cHUWVgBkI');
...
app.post('/login', async(req, res) => {
    ...
    try {
        const isAuthenticated = await contract.methods.login(email, password).call({ from: '0xD5bb55207be4Ad31ee1cC67a5923744DE558f8aC' });
        if (isAuthenticated) {
...
app.post('/add-event', upload.single('file'), async(req, res) => {
    ...
    try {
        await contract.methods.createEvent(eventName, description, date, latitude, longitude, fileUrl).send({ from: '0xD5bb55207be4Ad31ee1cC67a5923744DE558f8aC' });
...
app.get('/events', async(req, res) => {
    try {
        const events = await contract.methods.getEvents().call({ from: '0xD5bb55207be4Ad31ee1cC67a5923744DE558f8aC' });
        res.json(events);
    } catch (error) {
